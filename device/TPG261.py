...
class tpg261(object):
    ...
    def query_pressure(self):
        ...
        """
        self.clientsock.sendall('PR1 \r\n')
        time.sleep(0.5)
        self.clientsock.sendall('\x05')
        time.sleep(0.5)
        raw = self.clientsock.recv(256)
        line = raw.split('\r\n')
        rets = line[1].split(',')
        pressure = float(rets[1])
        return pressure
    ...
    def set_unit(self, unit='torr'):
        ...
        """
        if unit=='bar':
            self.clientsock.sendall('UNI,0 \r\n')
        elif unit=='torr':
            self.clientsock.sendall('UNI,1 \r\n')
        elif unit=='pascal':
            self.clientsock.sendall('UNI,2 \r\n')
        else:
            print('!!!!ERROR!!!!')
    ...
    def query_baurate(self):
        ...
        1. bau: bau rate of the TPG261
            Type: int (9600, 19200 or 38400)
        """
        parameter = [9600, 19200, 38400]
        self.clientsock.sendall('BAU \r\n')
        time.sleep(0.5)
        self.clientsock.sendall('\x05')
        time.sleep(0.5)
        raw = self.clientsock.recv(256)
    ...
    def set_baurate(self, rate=9600):
        ...
        """
        if rate==9600:
            self.clientsock.sendall('BAU,0 \r\n')
        elif rate==19200:
            self.clientsock.sendall('BAU,1 \r\n')
        elif rate==38400:
            self.clientsock.sendall('BAU,2 \r\n')
        else:
            print('!!!!ERROR!!!!')
